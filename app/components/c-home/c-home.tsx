    ...
    <main className="row">
      <div className="col-sm-12">
          ...
          <div className="container py-5">
            <div className="row g-5 align-items-center">
              <div className="col-md-12 col-lg-7">
                <h4 className="mb-3 text-secondary">100% Prayer Goods</h4>
                  ...
                  <div className="service-item bg-secondary rounded border border-secondary">
                    ...
                    <div className="px-4 rounded-bottom">
                      <div className="service-content bg-primary text-center p-4 rounded">
                        <h5 className="text-white">Sweet Meats</h5>
                  ...
                  <div className="service-item bg-dark rounded border border-dark">
                    ...
                    <div className="px-4 rounded-bottom">
                      <div className="service-content bg-light text-center p-4 rounded">
                        <h5 className="text-primary">Prayer Books</h5>
                  ...
                  <div className="service-item bg-primary rounded border border-primary">
                    ...
                    <div className="px-4 rounded-bottom">
                      <div className="service-content bg-secondary text-center p-4 rounded">
                        <h5 className="text-white">Prayer Utilities</h5>
        ...
        <div className="container-fluid vesitable py-5">
          <div className="container py-5">
            <h1 className="mb-0">Prayer Goods</h1>
          ...
          <div className="container py-5">
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                <div className="py-4">
                  <h1 className="display-3 text-white">Prayer Goods</h1>
        ...
        <div className="container-fluid py-5">
          <div className="container py-5">
            ...
            >
              <h1 className="display-4">Bestseller Prayer Goods</h1>
              <p>
